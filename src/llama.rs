// Vendored from Hugging Face Candle's `candle-transformers` crate.
// Source file: candle-transformers/src/models/llama.rs
// Version copied from this project lockfile: candle-transformers 0.11.0
// Original project: https://github.com/huggingface/candle
//
// Local copy exists so this inference engine can directly evolve the Llama
// KV-cache implementation for optimization work.
...
impl CausalSelfAttention {
    ...
    fn repeat_kv(&self, x: Tensor) -> Result<Tensor> {
        repeat_kv(x, self.num_attention_heads / self.num_key_value_heads)
    }
